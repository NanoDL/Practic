...
Необходимые. Эти файлы нужны для обеспечения <?php echo $date ?>правильной работы сайта, использования его функций. Отключение использования таких файлов приведет к падению производительности сайта, невозможности использовать его компоненты и сервисы.
...
Сторонние веб-сервисы. Иногда на данном сайте мы используем _сторонние веб-сервисы_. Например, для отображения тех или иных _элементов_ (изображения, видео, презентации и т. п.), организации опросов и т. п. Как и в случае с кнопками доступа к социальным сетям, мы не можем препятствовать сбору этими сайтами или внешними доменами информации о том, как вы используете содержание сайта.
